...
| **Eligible Slots** | Any headgear that occupies the middle slot (including multi-slot headgears) + Footgear |
...
| Change | Description |
|--------|-------------|
| <img src="../../../img/skill_369.png" alt="" style="vertical-align:middle;width:1.25rem;height:1.25rem;"> **Gospel** | Added icons for Gospel buffs |
