...
| Fix | Description |
|-----|-------------|
| **Bubble Gum** | Fixed the original server core Bubble Gum script using +200% (300% total) drop rate instead of the intended +100% (200% total). This corrects the drop rate to properly double as intended |
